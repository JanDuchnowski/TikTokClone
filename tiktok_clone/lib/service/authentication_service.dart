...
class AuthenticationService {
  ...
  Future<model.User?> getCurrentUser() async {
    ...
    print(Storage().firebaseAuth.currentUser);
  ...
  Future<void> registerUser(
    ...
    try {
      if (username.isNotEmpty &&
        ...
        String downloadUrl = await _uploadToStorage(image, 'profilePics');
  ...
  void loginUser(String email, String password) async {
    try {
      if (email.isNotEmpty && password.isNotEmpty) {
        ...
        print(
            "Please input all the credentials"); //Make it impossible to login in without all credentials
      }
    } catch (e) {
      print(e);
    }
